								...
								<c:choose>
									<c:when test="${followable == null}">
										<div class="user-pad">
											<h2>
												Welcome back! <a
													href="view-user.do?userName=${viewUser.getUserName() }">
													${viewUser.getUserName() }</a>
											</h2>
										</div>
									</c:when>
	...
	<div class="main-posts">
		<div class="container">
			...
			<c:forEach var="followed" items="${followeds}">
				<div class="container-fluid well span6 col-md-4 col-sm-1"
					...
					<div class="row-fluid">
						...
						<div class="span2 col-sm-1" style="padding: 50px">
							...
							<br>
							<h6>
								<a href="view-user.do?userName=${followed.getFollowed()}">More...
								</a>
							</h6>
						</div>
					</div>
